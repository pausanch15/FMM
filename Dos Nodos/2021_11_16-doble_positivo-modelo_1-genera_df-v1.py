#Es lo que vi que podía usar en modelo_1-v3, pero con el nombre correcto.
#En otro código levanto del dataframe que genere acá
#%%
#La forma del dataframe es algo así
#  S  │   k_sb=5  │   k_sb=6  │
# ────┼─────┬─────┼─────┬─────┼
#     │  A  │  B  │  A  │  B  │
# ────┼─────┼─────┼─────┼─────┼
