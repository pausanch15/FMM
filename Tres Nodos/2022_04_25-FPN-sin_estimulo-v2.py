#Mismo modelo que el que está en v1, pero desacoplo el C2 del feedback positivo, como dijo Ale.
...
tiempo, variables = fpndes.integra_FPN(C2, dYX2, dX2, Ty2, dy2, TY2, dY2, tiempo_max=100000)
